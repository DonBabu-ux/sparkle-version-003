ç▒≡ƒç░', '≡ƒçº≡ƒç▒', '≡ƒç╕≡ƒç¡', '≡ƒç░≡ƒç│', '≡ƒç▒≡ƒç¿', '≡ƒç▓≡ƒç½', '≡ƒç╡≡ƒç▓', '≡ƒç╗≡ƒç¿', '≡ƒç╕≡ƒç⌐', '≡ƒç╕≡ƒç╖', '≡ƒç╕≡ƒç¬', '≡ƒç¿≡ƒç¡', '≡ƒç╕≡ƒç╛', '≡ƒç╣≡ƒç╝', '≡ƒç╣≡ƒç»', '≡ƒç╣≡ƒç┐', '≡ƒç╣≡ƒç¡', '≡ƒç╣≡ƒç▒', '≡ƒç╣≡ƒç¼', '≡ƒç╣≡ƒç░', '≡ƒç╣≡ƒç┤', '≡ƒç╣≡ƒç╣', '≡ƒç╣≡ƒç│', '≡ƒç╣≡ƒç╖', '≡ƒç╣≡ƒç▓', '≡ƒç╣≡ƒç¿', '≡ƒç╣≡ƒç╗', '≡ƒç╗≡ƒç«', '≡ƒç║≡ƒç¼', '≡ƒç║≡ƒçª', '≡ƒçª≡ƒç¬', '≡ƒç¼≡ƒçº', '≡ƒÅ┤≤áüº≤áüó≤áüÑ≤áü«≤áüº≤áü┐', '≡ƒÅ┤≤áüº≤áüó≤áü│≤áüú≤áü┤≤áü┐', '≡ƒÅ┤≤áüº≤áüó≤áü╖≤áü¼≤áü│≤áü┐', '≡ƒç║≡ƒç╕', '≡ƒç║≡ƒç╛', '≡ƒç║≡ƒç┐', '≡ƒç╗≡ƒç║', '≡ƒç╗≡ƒçª', '≡ƒç╗≡ƒç¬', '≡ƒç╗≡ƒç│', '≡ƒç╝≡ƒç½', '≡ƒç¬≡ƒç¡', '≡ƒç╛≡ƒç¬', '≡ƒç┐≡ƒç▓', '≡ƒç┐≡ƒç╝']
};
...
export default function Messages() {
  ...
  const [newWordEffect, setNewWordEffect] = useState({ word: '', emoji: '≡ƒÿÇ' });
  const [partnerIsTyping, setPartnerIsTyping] = useState(false);
  const [typingUsers, setTypingUsers] = useState<{chatId: string, name: string}[]>([]);
  const [isNearBottom, setIsNearBottom] = useState(true);
  const isNearBottomRef = useRef(true);
  // Tracks whether the user is actively scrolling ΓÇö used to subtly dim header presence text
  ...
  const notePlaceholder = "Feeling sparkle Γ£¿";
  ...
  // showLastSeen is always true for offline partners ΓÇö no toggling timer
  // The AnimatePresence in the header already handles smooth Online Γåö last-seen transitions
  ...
  const handleOpenDirectChat = (contact: any) => {
    ...
    if (existing) {
      ...
      // Create a temporary chat object for the UI ΓÇö no client-generated timestamps
      setSelectedChat({
  ...
  useEffect(() => {
    ...
    const handleNewMessage = (msg: any) => {
      ...
      // 2. Reactively update the conversations list ΓÇö use ONLY server-provided timestamps
      setConversations((prev: any[]) => {
        ...
        if (chatIndex >= 0) {
          ...
          // Use server timestamp only ΓÇö never fall back to client Date
  ...
  const handleSendMessage = async (e?: React.FormEvent, contentOverride?: string, specialType?: string, mediaUrl?: string) => {
    ...
    socket?.emit('send-message', {
       ...
       if (response.success && response.messageId) {
          // ACK received ΓÇö use server-returned sentAt (never client Date)
  ...
  const handleScroll = (e: any) => {
    ...
    // Mark as scrolling ΓÇö debounce the stop signal 300ms after last scroll event
   ...
   * Never uses relative counters ΓÇö always anchors to today / yesterday / weekday / date.
  ...
  const formatMessageText = (content?: string) => {
    ...
    try {
      ...
      if (parsed.type === 'camera_capture') return '≡ƒô╖ Photo';
      if (parsed.type === 'marketplace_inquiry') return '≡ƒ¢Æ Marketplace inquiry';
    } catch (e) {}
    return content;
  };
  ...
  const getStatusLabel = (chat: ChatConversation) => {
    ...
    // Map backend 'read' ΓåÆ display 'Seen', 'delivered' ΓåÆ 'Delivered', else 'Sent'
    // IMPORTANT: Never derive 'Delivered' from partner_online ΓÇö that causes false positives.
  ...
  /** Compact, human-readable timestamp ΓÇö delegates to shared utility so format is consistent everywhere */
  ...
  return (
    <AppScreen immersive={true} scrollable={false} statusBarStyle="transparent-dark" className="flex flex-col h-screen bg-[#121212] text-white overflow-hidden md:pl-[72px]">
      ...
      <KeyboardAwareChatLayout className="flex flex-1 overflow-hidden relative">
        ...
        <aside className={clsx(
          ...
          <header className="px-5 pt-4 pb-2 overflow-visible bg-[#121212]">
             ...
             {/* Notes Row ΓÇö reduced size and pushed up */}
                      ...
                      <div className="flex-1 min-w-0">
                        {chat.unread_count > 1 ? (
                          ...
                          return (
                            <div className="flex items-center gap-1.5 truncate">
                              {isTypingHere ? (
                                <p className="text-[12px] font-bold text-[#ff1493] italic animate-pulse">TypingΓÇª</p>
                              ) : (
        ...
        <main className={clsx(
          ...
          {selectedChat ? (
            <>
                    ...
                    >
                      <AnimatePresence mode="wait">
                        {(selectedChat.is_group || selectedChat.chat_type === 'group') ? (
                          ...
                          >
                            {selectedChat.member_count ? `${selectedChat.member_count} members ΓÇó ` : ''}{selectedChat.group_online_count || 1} online
                          </motion.p>
              ...
              {/* ΓöÇΓöÇ Scroll-to-bottom floating button ΓöÇΓöÇ
              ...
              {/* Typing indicator ΓÇö sits directly above the input bar */}
              <AnimatePresence>
                {partnerIsTyping && (
                  <motion.div
                    initial={{ height: 0, opacity: 0 }}
                  ...
                  >
                    ...
                    <span className="text-[11px] font-semibold text-white/50">{selectedChat.partner_name} is typingΓÇª</span>
                  </motion.div>
                )}
              </AnimatePresence>
      ...
      {/* VIEW NOTE MODAL ΓÇö Full Screen */}
      <AnimatePresence>
        {showViewNoteModal && viewingNote && (
          ...
          >
            ...
            {/* Bottom ΓÇö Send message + quick reactions */}
      ...
      {/* ΓöÇΓöÇ 1. FLOATING ATTACHMENT BOTTOM SHEET ΓöÇΓöÇ */}
      <AnimatePresence>
        {showAttachmentSheet && (
      ...
      {/* ΓöÇΓöÇ 2. MULTIPLE SELECTION MEDIA COMPOSER ΓöÇΓöÇ */}
      <AnimatePresence>
        {showMediaComposer && (
      ...
      {/* ΓöÇΓöÇ 3. CONCURRENT UPLOAD QUEUE FLOATING WIDGET ΓöÇΓöÇ */}
      <AnimatePresence>
      ...
      {/* ΓöÇΓöÇ 4. LIGHTBOX IMAGE VIEW OVERLAY ΓöÇΓöÇ */}
      <AnimatePresence>
        {lightboxUrl && (
