  ...
  return (
    <div className="fixed inset-0 bg-black text-white overflow-hidden select-none safe-area-top safe-area-bottom">
      ...
      <AnimatePresence mode="wait">
          {/* 1. ENTRY PHASE */}
          {phase === 'entry' && (
              <motion.div key="entry" initial={{ y: '100%' }} animate={{ y: 0 }} exit={{ y: '100%' }} className="absolute inset-0 bg-white dark:bg-black text-black dark:text-white z-[200] flex flex-col">
